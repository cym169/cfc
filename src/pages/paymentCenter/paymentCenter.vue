<template>
    <div>
        ...
        <div class="content">
            ...
            <p class="name">支付方式：</p>
            <check-icon class="check-item" :value.sync="score" @click.native="scoreClick">积分<input
                v-model="convertAmount" type="text" @click.stop.prevent="scoreInput" class="input-item"
                style="margin-left:25px;"></check-icon>
...
<script>
    import Vue from 'vue'
    import {
        AjaxPlugin, Alert, AlertPlugin, XDialog, cookie,
