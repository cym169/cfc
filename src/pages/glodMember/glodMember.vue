<template>
    <div>
        ...
        <!-- <div v-show="initUserInfo.type === 2" style="padding:50px 30px 0 30px;">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            AjaxPlugin.$http.get('http://wx.wident.cn/server/mp/signature/wx9962603dfa0540e2?url=http://wx.wident.cn/cfc/glodMember.html')
                .then((res) => {
                    this.init = res.data
                    this.$wechat.config({
...
<style lang="scss" src="./glodMember.scss"></style>
