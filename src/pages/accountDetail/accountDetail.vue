<template>
  <div>
    <div class="header">
      ...
      <p class="header-center" v-if="detailList.payType === 2">+{{detailList.convertAmount * -1}}<span>积分</span></p>
    ...
    <div class="content">
      <div class="content-item">
        付款方式<div class="content-item-right">{{detailList.payType === 1 ? '余额支付' : '积分支付'}}</div>
      </div>
      <div class="content-item">
        商品备注<div class="content-item-right">{{detailList.remark}}</div>
      </div>
      <div class="content-item">
        付款卡号<div class="content-item-right">{{detailList.userNum}}</div>
      </div>
      <div class="content-item" v-if="detailList.payType === 1">
        积分奖励<div class="content-item-right">+{{detailList.reward}}积分</div>
      </div>
      <div class="divider"></div>
      <div class="content-item">
        创建时间<div class="content-item-right">{{detailList.createTime | dateFormat}}</div>
      </div>
      <div class="content-item">
        订单号<div class="content-item-right">{{detailList.id}}</div>
      </div>
    </div>
  </div>
</template>
