    ...
    <div>
        <div class="item">
            ...
            <div class="content">
                ...
                <x-button :gradients="['#c7a062', '#c7a062']" style="border-radius:99px" @click.native="linkToGlodCard">
                    立即领取
                </x-button>
            </div>
        </div>
        <div class="item">
            ...
            <div class="content">
                ...
                <x-button :gradients="['#c7a062', '#c7a062']" style="border-radius:99px" @click.native="linkToPukaCard">
                    立即领取
                </x-button>
            </div>
        </div>
