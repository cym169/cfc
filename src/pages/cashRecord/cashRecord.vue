        ...
        <div class="content">
            ...
            <div class="content-item" v-for='item of cashList' :key='item.id' @click="linkToAccountDetail(item.id)">
                ...
                <div class="content-item-right">
                    ...
                    <p class="content-item-right-num">+{{ item.payType === 1 ? item.payAmount : item.convertAmount
                        }}</p>
                </div>
            </div>
        </div>
...
<script>
    ...
    import {
        ...
        CheckIcon, Datetime, Flexbox, FlexboxItem, Divider
    } from 'vux'
    ...
    export default {
        ...
        methods: {
            ...
            search() {
                ...
                AjaxPlugin.$http.post(this.baseUrl + '/admin/balanceList', {
                    'type': 1,
