<template>
    <div>
        ...
        <group>
            ...
            <x-input title="手机号码" placeholder="请输入手机号" required :max="13" v-model="tel" required
        ...
        <div class="checkbox" style="font-size:12px; color:#000; padding:0 10px 15px 10px">
            <check-icon :value.sync="agree">我已阅读并同意<a href="" alt="" style="color:#1984fd; margin:0 5px;">会员守则</a>和<a
                href="" alt="" style="color:#1984fd; margin:0 5px;">会员卡使用声明</a></check-icon>
        </div>
...
<script>
    import Vue from 'vue'
    import {
        WechatPlugin, AjaxPlugin, AlertPlugin, cookie,
        Group, Cell, XInput, XButton, CheckIcon
    } from 'vux'
    ...
    export default {
        ...
        methods: {
            ...
            submitForm() {
                ...
                AjaxPlugin.$http.post(this.baseUrl + '/register', {
                    'id': this.cookies,
                    'phone': this.tel,
                    'name': this.membername,
                    'vrifyCode': this.telValidates
                })
                    .then((res) => {
                        if (res.data.success) {
